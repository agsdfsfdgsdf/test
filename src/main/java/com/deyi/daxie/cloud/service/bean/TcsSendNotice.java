...
/**
 * 
 * @TableName tcs_send_notice
 */
@Data
public class TcsSendNotice implements Serializable {
    /**
     * 主键，自增
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TcsSendNotice other = (TcsSendNotice) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getParamNotice() == null ? other.getParamNotice() == null : this.getParamNotice().equals(other.getParamNotice()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getParamNotice() == null) ? 0 : getParamNotice().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", paramNotice=").append(paramNotice);
