...
/**
 * 
 * @TableName tcs_websocket_truck_drive_away
 */
@Data
public class TcsWebsocketTruckDriveAway implements Serializable {
    /**
     * 主键，自增
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TcsWebsocketTruckDriveAway other = (TcsWebsocketTruckDriveAway) that;
