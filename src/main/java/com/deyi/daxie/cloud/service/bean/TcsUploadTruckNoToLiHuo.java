...
/**
 * 
 * @TableName tcs_upload_truck_no_to_li_huo
 */
@Data
public class TcsUploadTruckNoToLiHuo implements Serializable {
    /**
     * 主键，自增
     */
    private Long id;
     ...
     * 
     */
    private String paramQcInfo;

    /**
     * 
     */
    private String paramTruckInfo;
    ...
    public boolean equals(Object that) {
        ...
        TcsUploadTruckNoToLiHuo other = (TcsUploadTruckNoToLiHuo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getParamQcInfo() == null ? other.getParamQcInfo() == null : this.getParamQcInfo().equals(other.getParamQcInfo()))
            && (this.getParamTruckInfo() == null ? other.getParamTruckInfo() == null : this.getParamTruckInfo().equals(other.getParamTruckInfo()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getParamQcInfo() == null) ? 0 : getParamQcInfo().hashCode());
        result = prime * result + ((getParamTruckInfo() == null) ? 0 : getParamTruckInfo().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", paramQcInfo=").append(paramQcInfo);
        sb.append(", paramTruckInfo=").append(paramTruckInfo);
