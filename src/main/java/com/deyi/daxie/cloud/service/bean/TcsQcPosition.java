...
/**
 * 
 * @TableName tcs_qc_position
 */
@Data
public class TcsQcPosition implements Serializable {
    /**
     * 主键，自增
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TcsQcPosition other = (TcsQcPosition) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getParamLon() == null ? other.getParamLon() == null : this.getParamLon().equals(other.getParamLon()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getParamLon() == null) ? 0 : getParamLon().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", paramLon=").append(paramLon);
