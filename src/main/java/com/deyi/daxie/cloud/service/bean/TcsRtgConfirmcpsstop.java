...
/**
 * 
 * @TableName tcs_RTG_confirmCpsStop
 */
@Data
public class TcsRtgConfirmcpsstop implements Serializable {
    /**
     * 主键，自增
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TcsRtgConfirmcpsstop other = (TcsRtgConfirmcpsstop) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getParamRtg() == null ? other.getParamRtg() == null : this.getParamRtg().equals(other.getParamRtg()))
            ...
            && (this.getParamOrderid() == null ? other.getParamOrderid() == null : this.getParamOrderid().equals(other.getParamOrderid()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getParamRtg() == null) ? 0 : getParamRtg().hashCode());
        ...
        result = prime * result + ((getParamOrderid() == null) ? 0 : getParamOrderid().hashCode());
