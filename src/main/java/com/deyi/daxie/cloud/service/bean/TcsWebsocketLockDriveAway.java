...
/**
 * 
 * @TableName tcs_websocket_lock_drive_away
 */
@Data
public class TcsWebsocketLockDriveAway implements Serializable {
    /**
     * 主键，自增
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TcsWebsocketLockDriveAway other = (TcsWebsocketLockDriveAway) that;
