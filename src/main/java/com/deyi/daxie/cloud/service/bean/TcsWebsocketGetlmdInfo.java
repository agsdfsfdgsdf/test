...
/**
 * 
 * @TableName tcs_websocket_get_zl_info
 */
@Data
public class TcsWebsocketGetlmdInfo implements Serializable {
    /**
     * 主键，自增
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        TcsWebsocketGetlmdInfo other = (TcsWebsocketGetlmdInfo) that;
